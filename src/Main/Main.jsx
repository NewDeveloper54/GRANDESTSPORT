        ...
        <div className="elements">
          ...
          >
            <div className="item five">
              <img src={familleNotaire} alt="" height="130" width="130" />
          ...
          >
            <div className="item six">
              <img src={formation} alt="" height="130" width="130" />
          ...
          >
            <div className="item seven">
              <img src={territoriale} alt="" height="200" width="150" />
          ...
          >
            <div className="item eight">
              <img src={notaire} height="180" width="130" alt="" />
